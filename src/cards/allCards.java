...
public class allCards extends javax.swing.JPanel {

    public allCards(int paneles, boolean search) {
        initComponents();
        load(paneles, search);
    }
    ...
    public void load(int paneles, boolean search){
        ...
        for(int count = 0; count<paneles; count++){
            ...
            showCard showP = new showCard(count, search);
