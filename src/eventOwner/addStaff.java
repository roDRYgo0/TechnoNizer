...
public class addStaff extends javax.swing.JPanel {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(cmbPos, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
        ...
        if(user){
            ...
            if(cmbPos.getSelectedIndex() == num){
                ...
                if(controller.member[classUsuario.getIdMemberships()-1].getNumberModerators() > mod){
                    ...
                    standardization.showMessage("warning", "No se pueden agregar más moderadores");
            }
        }else
    ...
    void add(){
        if(classEvent.insetStaff(idEvent, (classEvent.position == 1)?2:cmbPos.getSelectedIndex()+1, txtNickname.getText())){
            staff s = new staff();
            s.setNickname(txtNickname.getText());
            s.setPosition((classEvent.position == 1)?2:cmbPos.getSelectedIndex()+1);
