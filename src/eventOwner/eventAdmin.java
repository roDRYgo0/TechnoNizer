...
public class eventAdmin extends javax.swing.JPanel {
    ...
    public void load(event event, boolean load){
        ...
        lblIncome.setText("$"+(double)Math.round(income() * 100d) / 100d);

        lblGain.setText("$"+(double)Math.round((income()-lost()) * 100d) / 100d);
    ...
    void loadProblems(){
        problemsMenu problem = new problemsMenu(idEvent);
        int size;
        int count = 0;
        ...
        problem.setPreferredSize(new Dimension(945,100+size));
        
        pnContainer.add(problem);
        pnContainer.revalidate();
        pnContainer.repaint();
    }
    
    void loadAnnouncement(){
        announcementMenu announced = new announcementMenu(idEvent);
        int size;
        int count = 0;
        ...
        announced.setPreferredSize(new Dimension(945,100+size));
        
        pnContainer.add(announced);
        pnContainer.revalidate();
        pnContainer.repaint();
    }
    ...
    private void initComponents() {
        ...
        jPanel6Layout.setHorizontalGroup(
                    ...
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                                .addGap(0, 0, Short.MAX_VALUE)
                                .addComponent(lblIncome, javax.swing.GroupLayout.PREFERRED_SIZE, 148, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addContainerGap()
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel6Layout.createSequentialGroup()
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                .addGap(0, 0, Short.MAX_VALUE)
                .addComponent(lblGain, javax.swing.GroupLayout.PREFERRED_SIZE, 261, javax.swing.GroupLayout.PREFERRED_SIZE)
