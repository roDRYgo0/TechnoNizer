...
public class pnTeams extends javax.swing.JPanel {

    int idProject;
    
    public pnTeams(int idProject) {
        initComponents();
    ...
    void load(){
        showTeams owner = new showTeams(true, false, idProject);
        ...
        if(classProjects.projectsShow.get(idProject).getMembers() != null){
            for(int i = 0; i < classProjects.projectsShow.get(idProject).getMembers().size(); i++){
                showTeams sS = new showTeams(false, false, idProject, i);
                sS.setSize(370, 45);
    ...
    private void initComponents() {
        ...
        jPanel4.setPreferredSize(new java.awt.Dimension(440, 62));
