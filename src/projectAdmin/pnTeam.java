...
public class pnTeam extends javax.swing.JPanel {

    int idProject;
    
    public pnTeam(int idProject) {
        initComponents();
    ...
    void load(){
        showTeams owner = new showTeams(true, true, idProject);
        ...
        if(classProjects.projectsShow.get(idProject).getMembers()!= null){
            for(int i = 0; i < classProjects.projectsShow.get(idProject).getMembers().size(); i++){
                showTeams sS = new showTeams(false, true, idProject, i);
                sS.setSize(370, 45);
        ...
        addTeam aS = new addTeam(idProject);
        aS.setSize(370, 45);
