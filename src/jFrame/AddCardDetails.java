...
public class AddCardDetails extends javax.swing.JFrame {

    Card card;
    CheckList[] items;
    
    public AddCardDetails(Card card, CheckList[] items) {
    ...
    private void btnNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextActionPerformed
        standardization.hide(controller.addCrDetails);
    }//GEN-LAST:event_btnNextActionPerformed

    private void btnNext1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNext1ActionPerformed
        standardization.hide(controller.addCrDetails);
        
        int idcard = card.insert();
        if (idcard == 0) {
            standardization.showMessage("cancel", "No se pudo crear la tarjeta", technonizer.TechnoNizer.home);
            return;
        }
        ...
        standardization.showMessage("ok", "Exito al crear la tarjeta", technonizer.TechnoNizer.home);
