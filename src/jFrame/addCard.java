...
public class addCard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        addprojectlbl.setText("Agregar tarjeta");
    ...
    private void btnNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextActionPerformed
        ...
        standardization.hide(controller.addCr);
    ...
    private void btnNext1ProjectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNext1ProjectActionPerformed
        ...
        {
            if(methodsSQL.exists("SELECT title FROM cards WHERE title = ?", txtTitle.getText()))
                ...
                standardization.hide(controller.addCr);
                controller.addCrDetails = new AddCardDetails(card, items);
                standardization.show(controller.addCrDetails);
                controller.rootFrame = controller.addCrDetails;
            }
        }
