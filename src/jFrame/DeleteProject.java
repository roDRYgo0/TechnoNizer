...
public class DeleteProject extends javax.swing.JFrame {
    ...
    JTable tabla;
    public DeleteProject(JTable tb) {
        initComponents();
        tabla = tb;
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("ELIMINAR PROYECTO");
        ...
        jLabel1.setText("Ingrese el ID del proyecto a Eliminar");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(txtID.getText().isEmpty()){
            ...
            classProjects.setId((Integer.parseInt(txtID.getText())));    
        ...
        standardization.hidedeleteProject(TechnoNizer.home);
