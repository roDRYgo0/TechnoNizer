...
public class showStaffMenu extends javax.swing.JPanel {
    ...
    TitleuserStaffMenu.setText(pr.getProperty("TitleuserStaffMenu"));
    }
    ...
    void load(boolean owner){
        if(owner){
            ...
            iconPos.setText(pr.getProperty("Creator"));
        }else{
            switch(classEvent.eventosShow.get(idEvent).getStaffs().get(staff).getPosition()){
                case 1:
                    ...
                    iconPos.setText(pr.getProperty("Administrator"));
                    break;
                case 2:
                    txtNickname.setText(classEvent.eventosShow.get(idEvent).getStaffs().get(staff).getNickname());
                    iconPos.setIcon(new controller().changeImage("/imagenes/mod.png", 25, 25));
                    iconPos.setText(pr.getProperty("Moderator"));
                    break;
            }
        }
    }
    ...
    private void initComponents() {
        ...
        TitleuserStaffMenu = new javax.swing.JLabel();
        ...
        TitleuserStaffMenu.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        TitleuserStaffMenu.setForeground(new java.awt.Color(102, 102, 102));
        TitleuserStaffMenu.setText("Nombre de usuario");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(TitleuserStaffMenu, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(TitleuserStaffMenu)
                        .addGap(0, 0, 0)
    ...
    private javax.swing.JLabel TitleuserStaffMenu;
