...
public final class jpMyEvent extends javax.swing.JPanel {

    void verificaridioma()
    {
      Properties pr = new propiedades (controller.idioma);
       
    lblEventjpE.setText(pr.getProperty("lblEventjpE"));
    ...
    public jpMyEvent(boolean start) {
        initComponents();
    ...
    public void insertarPaneles(int paneles, boolean search){
        ...
        for(int i = 0; i < classEvent.eventosShow.size(); i++){
            eventOwner.showEvent show = new eventOwner.showEvent(i);
